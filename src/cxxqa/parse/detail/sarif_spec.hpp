...
struct PropertyBag {
  ...
  std::optional<std::unordered_map<std::string, std::string>> additionalProperties;
  // TODO: glz::generic
};
...
struct ToolComponentReference {
  ...
  std::optional<int32_t> index = -1;

  /// The 'guid' property of the referenced toolComponent.
  std::optional<std::string> guid;

  /// Key/value pairs that provide additional information about the toolComponentReference.
  std::unique_ptr<PropertyBag> properties;
};
...
struct ArtifactContent {
  ...
  std::unique_ptr<MultiformatMessageString> rendered;
...
struct ArtifactLocation {
  ...
  std::optional<std::string> uriBaseId;

  /// The index within the run artifacts array of the artifact object associated with the artifact location.
  std::optional<int32_t> index = -1;

  /// A short description of the artifact location.
  std::unique_ptr<Message> description;
...
struct Region {
  ...
  std::optional<uint32_t> startLine;
  ...
  std::optional<int32_t> charOffset = -1;

  /// The length of the region in characters.
  std::optional<int32_t> charLength;

  /// The zero-based offset from the beginning of the artifact of the first byte in the region.
  std::optional<int32_t> byteOffset = -1;

  /// The length of the region in bytes.
  std::optional<int32_t> byteLength;

  /// The portion of the artifact contents within the specified region.
  std::unique_ptr<ArtifactContent> snippet;
...
struct Address {
  ...
  std::optional<int64_t> absoluteAddress = -1;

  /// The address expressed as a byte offset from the absolute address of the top-most parent object.
  std::optional<int64_t> relativeAddress;
  ...
  std::optional<std::string> fullyQualifiedName;

  /// The byte offset of this address from the absolute or relative address of the parent object.
  std::optional<int32_t> offsetFromParent;

  /// The index within run.addresses of the cached object for this address.
  std::optional<int32_t> index = -1;

  /// The index within run.addresses of the parent object.
  std::optional<int32_t> parentIndex = -1;
...
struct Artifact {
  ...
  std::unique_ptr<ArtifactLocation> location;
  ...
  std::optional<int64_t> length = -1;

  /// The role or roles played by the artifact in the analysis.
  std::optional<std::vector<Role>> roles;  // "analysisTarget", "attachment", "responseFile", etc.

  /// The MIME type (RFC 2045) of the artifact.
  std::optional<std::string> mimeType;

  /// The contents of the artifact.
  std::unique_ptr<ArtifactContent> contents;
  ...
  std::optional<std::unordered_map<std::string, std::string>> hashes;
  ...
  std::optional<std::string> lastModifiedTimeUtc;
...
struct Replacement {
  ...
  std::unique_ptr<ArtifactContent> insertedContent;
...
struct Attachment {
  ...
  std::optional<std::vector<Rectangle>> rectangles;
...
struct LogicalLocation {
  ...
  std::optional<std::string> decoratedName;
...
struct LocationRelationship {
  ...
  std::optional<std::vector<std::string>> kinds = std::vector<std::string>{ "relevant" };
...
struct PhysicalLocation {
  ...
  std::unique_ptr<ArtifactLocation> artifactLocation;
  ...
  std::unique_ptr<Region> context_region;
...
struct Location {
  ...
  std::optional<int32_t> id = -1;

  /// Identifies the artifact and region.
  std::unique_ptr<PhysicalLocation> physicalLocation;

  /// The logical locations associated with the result.
  std::optional<std::vector<LogicalLocation>> logicalLocations;

  /// A message relevant to the location.
  std::unique_ptr<Message> message;

  /// A set of regions relevant to the location.
  std::optional<std::vector<Region>> annotations;

  /// An array of objects that describe relationships between this location and others.
  std::optional<std::vector<LocationRelationship>> relationships;
...
struct Graph {
  ...
  std::optional<std::vector<Edge>> edges;
...
struct EdgeTraversal {
  ...
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> finalState;

  /// The number of edge traversals necessary to return from a nested graph.
  std::optional<int32_t> stepOverEdgeCount;
...
struct GraphTraversal {
  ...
  std::optional<int32_t> runGraphIndex = -1;

  /// The index within the result.graphs to be associated with the result.
  /// @warning Either this or `runGraphIndex` is required
  std::optional<int32_t> resultGraphIndex = -1;

  /// A description of this graph traversal.
  std::unique_ptr<Message> description;

  /// Values of relevant expressions at the start of the graph traversal that may change during graph traversal.
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> initialState;

  /// Values of relevant expressions at the start of the graph traversal that remain constant for the graph traversal.
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> immutableState;

  /// The sequences of edges traversed by this graph traversal.
  std::optional<std::vector<EdgeTraversal>> edgeTraversals;
...
struct WebRequest {
  ...
  std::optional<std::unordered_map<std::string, std::string>> parameters;

  /// The body of the request.
  std::unique_ptr<ArtifactContent> body;
...
struct WebResponse {
  ...
  std::optional<int32_t> status_code;
  ...
  std::optional<bool> noResponseReceived = false;
...
struct Exception {
  ...
  std::optional<std::vector<Exception>> innerExceptions;
...
struct ReportingDescriptorReference {
  ...
  std::unique_ptr<ToolComponentReference> toolComponent;
...
struct ThreadFlowLocation {
  ...
  std::optional<std::vector<ReportingDescriptorReference>> taxa;
  ...
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> state;

  /// An integer representing a containment hierarchy within the thread flow.
  std::optional<int32_t> nestingLevel;

  /// An integer representing the temporal order in which execution reached this location.
  std::optional<int32_t> executionOrder = -1;

  /// The Coordinated Universal Time (UTC) date and time at which this location was executed.
  std::optional<std::string> execution_time_utc;

  /// Specifies the importance of this location in understanding the code flow. "essential", "important", "unimportant".
  std::optional<Importance> importance = Importance::important;

  /// A web request associated with this thread flow location.
  std::unique_ptr<WebRequest> webRequest;

  /// A web response associated with this thread flow location.
  std::unique_ptr<WebResponse> webResponse;
...
struct ResultProvenance {
  ...
  std::optional<std::string> lastDetectionRunGuid;
  ...
  std::optional<int32_t> invocationIndex = -1;
  ...
  std::optional<std::vector<PhysicalLocation>> conversionSources;
...
struct ReportingConfiguration {
  ...
  std::optional<Level> level = Level::warning;

  /// Specifies the relative priority of the report. Used for analysis output only.
  std::optional<double> rank = -1;

  /// Contains configuration information specific to a report.
  std::unique_ptr<PropertyBag> parameters;
...
struct ReportingDescriptor {
  ...
  std::optional<std::vector<std::string>> deprecatedIds;

  /// A unique identifier for the reporting descriptor in the form of a GUID.
  std::optional<std::string> guid;

  /// An array of unique identifies in the form of a GUID by which this report was known in some previous version of the analysis tool.
  std::optional<std::vector<std::string>> deprecatedGuids;

  /// A report identifier that is understandable to an end user.
  std::optional<std::string> name;

  /// An array of readable identifiers by which this report was known in some previous version of the analysis tool.
  std::optional<std::vector<std::string>> deprecatedNames;

  /// A concise description of the report. Should be a single sentence.
  std::unique_ptr<MultiformatMessageString> shortDescription;
  ...
  std::unique_ptr<MultiformatMessageString> fullDescription;

  /// A set of name/value pairs with arbitrary names. Each value is a multiformatMessageString object.
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> messageStrings;

  /// Default reporting configuration information.
  std::unique_ptr<ReportingConfiguration> defaultConfiguration;

  /// A URI where the primary documentation for the report can be found.
  std::optional<std::string> helpUri;

  /// Provides the primary documentation for the report, useful when there is no online documentation.
  std::unique_ptr<MultiformatMessageString> help;

  /// An array of objects that describe relationships between this reporting descriptor and others.
  std::optional<std::vector<ReportingDescriptorRelationship>> relationships;
...
struct Result {
  ...
  std::optional<int32_t> ruleIndex = -1;

  /// A reference used to locate the rule descriptor relevant to this result.
  std::unique_ptr<ReportingDescriptorReference> rule;

  /// A value that categorizes results by evaluation state.
  /// Valid values: "notApplicable", "pass", "fail", "review", "open", "informational"
  std::optional<Kind> kind = Kind::fail;
  ...
  std::unique_ptr<ArtifactLocation> analysisTarget;
  ...
  std::optional<std::string> correlationGuid;

  /// A positive integer specifying the number of times this logically unique result was observed in this run.
  std::optional<uint32_t> occurrenceCount;

  /// A set of strings that contribute to the stable, unique identity of the result.
  std::optional<std::unordered_map<std::string, std::string>> partialFingerprints;

  /// A set of strings each of which individually defines a stable, unique identity for the result.
  std::optional<std::unordered_map<std::string, std::string>> fingerprints;

  /// An array of 'stack' objects relevant to the result.
  std::optional<std::vector<Stack>> stacks;

  /// An array of 'codeFlow' objects relevant to the result.
  std::optional<std::vector<CodeFlow>> codeFlows;

  /// An array of zero or more unique graph objects associated with the result.
  std::optional<std::vector<Graph>> graphs;

  /// An array of one or more unique 'graphTraversal' objects.
  std::optional<std::vector<GraphTraversal>> graphTraversals;

  /// A set of locations relevant to this result.
  std::optional<std::vector<Location>> relatedLocations;

  /// A set of suppressions relevant to this result.
  std::optional<std::vector<Suppression>> suppressions;

  /// The state of a result relative to a baseline of a previous run.
  /// Valid values: "new", "unchanged", "updated", "absent"
  std::optional<std::string> baselineState;
  ...
  std::optional<std::string> hostedViewerUri;

  /// The URIs of the work items associated with this result.
  std::optional<std::vector<std::string>> workItemUris;

  /// Information about how and when the result was detected.
  std::unique_ptr<ResultProvenance> provenance;

  /// An array of 'fix' objects, each of which represents a proposed fix to the problem indicated by the result.
  std::optional<std::vector<Fix>> fixes;
...
struct SpecialLocations {
  ...
  std::unique_ptr<ArtifactLocation> displayBase;
...
struct TranslationMetadata {
  ...
  std::optional<std::string> downloadUri;
...
struct ToolComponent {
  ...
  std::optional<std::string> productSuite;
  ...
  std::optional<std::string> dottedQuadFileVersion;

  /// A string specifying the UTC release date and optional time.
  std::optional<std::string> releaseDateUtc;
  ...
  std::optional<std::unordered_map<std::string, MultiformatMessageString>> globalMessageStrings;

  /// Reporting descriptors relevant to notifications.
  std::optional<std::vector<ReportingDescriptor>> notifications;

  /// Reporting descriptors relevant to analysis rules.
  std::optional<std::vector<ReportingDescriptor>> rules;

  /// Reporting descriptors relevant to taxonomy definitions.
  std::optional<std::vector<ReportingDescriptor>> taxa;

  /// Artifact locations associated with the tool component.
  std::optional<std::vector<ArtifactLocation>> locations;

  /// The language of emitted messages, defaulting to "en-US".
  std::optional<std::string> language = "en-US";

  /// The kinds of data contained in this object.
  std::optional<std::vector<LocalizedData>> contents = std::vector<LocalizedData>{ LocalizedData::localizedData, LocalizedData::nonLocalizedData };

  /// Specifies whether the object contains a complete definition of the component's data.
  std::optional<bool> isComprehensive = false;

  /// The semantic version of localized strings defined in this component.
  std::optional<std::string> localizedDataSemanticVersion;

  /// The minimum localizedDataSemanticVersion required in consumed translations.
  std::optional<std::string> minimumRequiredLocalizedDataSemanticVersion;

  /// The component strongly associated with this component.
  std::unique_ptr<ToolComponentReference> associatedComponent;

  /// Translation metadata (only for translation components).
  std::unique_ptr<TranslationMetadata> translationMetadata;

  /// Taxonomies supported by the tool component.
  std::optional<std::vector<ToolComponentReference>> supportedTaxonomies;
...
struct Tool {
  ...
  std::optional<std::vector<ToolComponent>> extensions;
...
struct VersionControlDetails {
  ...
  std::optional<std::string> revisionId;

  /// The name of a branch containing the revision.
  std::optional<std::string> branch;

  /// A tag that has been applied to the revision.
  std::optional<std::string> revisionTag;
...
struct Notification {
  ...
  std::optional<std::string> timeUtc;

  /// The runtime exception, if any, relevant to this notification.
  std::unique_ptr<Exception> exception;

  /// A reference used to locate the descriptor relevant to this notification.
  std::unique_ptr<ReportingDescriptorReference> descriptor;

  /// A reference used to locate the rule descriptor associated with this notification.
  std::unique_ptr<ReportingDescriptorReference> associatedRule;
...
struct Invocation {
  ...
  std::optional<std::vector<ArtifactLocation>> responseFiles;
  ...
  std::optional<std::string> endTimeUtc;

  /// The process exit code.
  std::optional<int> exitCode;

  /// An array of configurationOverride objects that describe rules related runtime overrides.
  std::optional<std::vector<ConfigurationOverride>> ruleConfigurationOverrides;

  /// An array of configurationOverride objects that describe notifications related runtime overrides.
  std::optional<std::vector<ConfigurationOverride>> notificationConfigurationOverrides;

  /// A list of runtime conditions detected by the tool during the analysis.
  std::optional<std::vector<Notification>> toolExecutionNotifications;

  /// A list of conditions detected by the tool that are relevant to the tool's configuration.
  std::optional<std::vector<Notification>> toolConfigurationNotifications;

  /// The reason for the process exit.
  std::optional<std::string> exitCodeDescription;

  /// The name of the signal that caused the process to exit.
  std::optional<std::string> exitSignalName;

  /// The numeric value of the signal that caused the process to exit.
  std::optional<int> exitSignalNumber;

  /// The reason given by the operating system that the process failed to start.
  std::optional<std::string> processStartFailureMessage;
  ...
  std::unique_ptr<ArtifactLocation> executableLocation;

  /// The working directory for the invocation.
  std::unique_ptr<ArtifactLocation> workingDirectory;

  /// The environment variables associated with the analysis tool process, expressed as key/value pairs.
  std::optional<std::unordered_map<std::string, std::string>> environmentVariables;

  /// A file containing the standard input stream to the process that was invoked.
  std::unique_ptr<ArtifactLocation> stdin;

  /// A file containing the standard output stream from the process that was invoked.
  std::unique_ptr<ArtifactLocation> stdout;

  /// A file containing the standard error stream from the process that was invoked.
  std::unique_ptr<ArtifactLocation> stderr;

  /// A file containing the interleaved standard output and standard error stream from the process that was invoked.
  std::unique_ptr<ArtifactLocation> stdoutStderr;
...
struct Conversion {
  ...
  std::optional<std::vector<ArtifactLocation>> analysisToolLogFiles;
...
struct Run {
  ...
  std::optional<std::vector<Invocation>> invocations;
  ...
  std::optional<std::vector<VersionControlDetails>> versionControlProvenance;

  /// The artifact location specified by each uriBaseId symbol on the machine where the tool originally ran.
  std::optional<std::unordered_map<std::string, ArtifactLocation>> originalUriBaseIds;
  ...
  std::unique_ptr<RunAutomationDetails> automationDetails;

  /// Automation details that describe the aggregate of runs to which this run belongs.
  std::optional<std::vector<RunAutomationDetails>> runAggregates;
  ...
  std::optional<std::string> baselineGuid;

  /// An array of strings used to replace sensitive information in a redaction-aware property.
  std::optional<std::vector<std::string>> redactionTokens;

  /// Specifies the default encoding for any artifact object that refers to a text file.
  std::optional<std::string> defaultEncoding;

  /// Specifies the default source language for any artifact object that refers to a text file that contains source code.
  std::optional<std::string> defaultSourceLanguage;

  /// An ordered list of character sequences that were treated as line breaks when computing region information for the run.
  /// { "\r\n", "\n" }
  std::optional<std::vector<std::string>> newlineSequences = std::vector<std::string>{ "\r\n", "\n" };

  /// Specifies the unit in which the tool measures columns.
  /// Valid values: "utf16CodeUnits", "unicodeCodePoints"
  std::optional<std::string> columnKind;

  /// References to external property files that should be inlined with the content of a root log file.
  std::unique_ptr<ExternalPropertyFileReference> externalPropertyFileReferences;

  /// An array of threadFlowLocation objects cached at run level.
  std::optional<std::vector<ThreadFlowLocation>> threadFlowLocations;

  /// An array of toolComponent objects relevant to a taxonomy in which results are categorized.
  std::optional<std::vector<ToolComponent>> taxonomies;

  /// Addresses associated with this run instance, if any.
  std::optional<std::vector<Address>> addresses;

  /// The set of available translations of the localized data provided by the tool.
  std::optional<std::vector<ToolComponent>> translations;
  ...
  std::optional<std::vector<ToolComponent>> policies;

  /// An array of request objects cached at run level.
  std::optional<std::vector<WebRequest>> webRequests;

  /// An array of response objects cached at run level.
  std::optional<std::vector<WebResponse>> webResponses;

  /// A specialLocations object that defines locations of special significance to SARIF consumers.
  std::unique_ptr<SpecialLocations> specialLocations;
