...
template <>
struct quick_status_code_from_enum<cxxqa::xml::Code> : quick_status_code_from_enum_defaults<cxxqa::xml::Code> {
  ...
  static auto value_mappings() -> const std::initializer_list<mapping>&
  {
    static const std::initializer_list<mapping> errors = {
      { .value = pugi::status_ok, .message = "OK", .code_mappings = { cxxqa::Code::success } },
