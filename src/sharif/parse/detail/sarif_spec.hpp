...
// local
#include <sharif/util/heap_optional.hpp>

// namespace
// NOLINTBEGIN(readability-identifier-naming)
namespace sharif::sarif {
...
template <>
struct meta<sharif::sarif::Role> {
  using enum_type             = sharif::sarif::Role;
...
template <>
struct meta<sharif::sarif::Level> {
  using enum_type             = sharif::sarif::Level;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::BaselineState> {
  using enum_type             = sharif::sarif::BaselineState;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::ColumnKind> {
  using enum_type             = sharif::sarif::ColumnKind;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::Importance> {
  using enum_type             = sharif::sarif::Importance;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::LocalizedData> {
  using enum_type             = sharif::sarif::LocalizedData;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::Suppression::Kind> {
  using enum_type             = sharif::sarif::Suppression::Kind;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::Suppression::Status> {
  using enum_type             = sharif::sarif::Suppression::Status;
  static constexpr auto value = glz::enumerate(
...
template <>
struct meta<sharif::sarif::Result::Kind> {
  using enum_type             = sharif::sarif::Result::Kind;
  static constexpr auto value = glz::enumerate(
