...
template <>
struct sharif::fmt::formatter<sharif::Diagnostic> : formatter<std::string_view> {
  auto format(const sharif::Diagnostic& self, format_context& ctx) const -> format_context::iterator;
};
