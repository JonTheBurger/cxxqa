...
/* Defines
 ******************************************************************************/
#define SHARIF_ERROR_NAMESPACE              BOOST_OUTCOME_SYSTEM_ERROR2_NAMESPACE
#define SHARIF_TRY(declaration, expression) OUTCOME_TRY(declaration, expression)
...
/// Format ErrorMessage
template <>
struct sharif::fmt::formatter<sharif::ErrorMessage> : formatter<std::string_view> {
  auto format(const sharif::ErrorMessage& self, format_context& ctx) const -> format_context::iterator;
};
